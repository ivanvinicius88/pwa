...
function preencherProduto(dados) {
    $.each( dados, function ( key, val )  {
        ...
        $(".foto").html(img);
        $(".descricao").html("<p class='text-center text-primary'> Descrição do Produto: </p><p class='text-center my-5'> "+val.prodescricao+"<p class='text-center text-primary'> R$: "+val.provalor+"</p></p><p class='text-center'><a href='categorias.html?id="+ val.catcodigo +"' class='btn btn-danger btn-lg'>Voltar</a></p>");
